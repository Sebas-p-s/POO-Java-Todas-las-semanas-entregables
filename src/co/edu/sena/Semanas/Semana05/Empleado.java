...
public class Empleado {
    ...
    public void informacionImportanteEmpleado(String nombre){
        System.out.println(nombre);
    }

    public void informacionImportanteEmpleado(String nombre, String cargo){
        System.out.println("Nombre del empleado: " + nombre + " su cargo es: " + cargo);
    }
